...
export const SCRIPTING_STUB_CHECKLIST: readonly StubEntry[] = Object.freeze([
    ...
    },
    {
        id: 'use_obj',
        kind: 'procedure',
        description: 'Player uses an object. Triggers use_p_proc on the target script. Required for door, terminal, and inventory interactions.',
        status: 'stub',
        frequency: 'high',
        impact: 'high',
    },
    {
        id: 'use_obj_on_obj',
        kind: 'procedure',
        description: 'Use one object on another (e.g. key on lock, stimpack on critter). Required for item-on-item and heal interactions.',
        status: 'stub',
        frequency: 'high',
        impact: 'high',
    },
