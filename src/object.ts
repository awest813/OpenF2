...
export class Critter extends Obj {
    ...
    init() {
        ...
        // default to punches
        if (!this.leftHand) {
            this.leftHand = <WeaponObj>{ type: 'item', subtype: 'weapon', weapon: new Weapon(null, this) }
        }
        if (!this.rightHand) {
            this.rightHand = <WeaponObj>{ type: 'item', subtype: 'weapon', weapon: new Weapon(null, this) }
        }
